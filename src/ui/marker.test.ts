...
describe('marker', () => {
    ...
    test('Marker#addTo adds the marker element to the canvas container', () => {
        ...
        expect(map.getCanvasContainer().querySelectorAll('.vietmapgl-marker')).toHaveLength(1);
    ...
    test('Marker anchor defaults to center', () => {
        ...
        expect(marker.getElement().classList.contains('vietmapgl-marker-anchor-center')).toBeTruthy();
    ...
    test('Marker anchors as specified by the anchor option', () => {
        ...
        expect(marker.getElement().classList.contains('vietmapgl-marker-anchor-top')).toBeTruthy();
    ...
    test('Popup anchors around default Marker', async () => {
        ...
        expect(
            marker.getPopup()._container.classList.contains('vietmapgl-popup-anchor-top-right')
        ).toBeTruthy();

        // move marker to the bottom left forcing the popup to the top right
        marker.setLngLat(map.unproject([markerRight, mapHeight]));
        expect(
            marker.getPopup()._container.classList.contains('vietmapgl-popup-anchor-bottom-left')
        ).toBeTruthy();
        ...
        expect(
            marker.getPopup()._container.classList.contains('vietmapgl-popup-anchor-bottom-right')
        ).toBeTruthy();
