...
export class Popup extends Evented {
    ...
    addTo(map: Map): this {
        ...
        if (this._trackPointer) {
            ...
            if (this._container) {
                this._container.classList.add('vietmapgl-popup-track-pointer');
            }
            this._map._canvasContainer.classList.add('vietmapgl-track-pointer');
        } else {
    ...
    remove = (): this => {
        ...
        if (this._map) {
            ...
            this._map._canvasContainer.classList.remove('vietmapgl-track-pointer');
            delete this._map;
    ...
    setLngLat(lnglat: LngLatLike): this {
        ...
        if (this._map) {
            ...
            this._map.off('mousemove', this._onMouseMove);
            if (this._container) {
                this._container.classList.remove('vietmapgl-popup-track-pointer');
            }
            this._map._canvasContainer.classList.remove('vietmapgl-track-pointer');
        }
    ...
    setDOMContent(htmlNode: Node): this {
        if (this._content) {
            ...
            this._content = DOM.create('div', 'vietmapgl-popup-content', this._container);
        }
    ...
    _createCloseButton() {
        if (this.options.closeButton) {
            this._closeButton = DOM.create('button', 'vietmapgl-popup-close-button', this._content);
    ...
    _update = (cursor?: Point) => {
        ...
        if (!this._container) {
            this._container = DOM.create('div', 'vietmapgl-popup', this._map.getContainer());
            this._tip       = DOM.create('div', 'vietmapgl-popup-tip', this._container);
