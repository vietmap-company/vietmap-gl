...
export class CooperativeGesturesHandler implements Handler {
    ...
    _setupUI() {
        ...
        mapCanvasContainer.classList.add('vietmapgl-cooperative-gestures');
        this._container = DOM.create('div', 'vietmapgl-cooperative-gesture-screen', mapCanvasContainer);
        ...
        desktopDiv.className = 'vietmapgl-desktop-message';
        ...
        mobileDiv.className = 'vietmapgl-mobile-message';
    ...
    _destoryUI() {
        if (this._container) {
            ...
            const mapCanvasContainer = this._map.getCanvasContainer();
            mapCanvasContainer.classList.remove('vietmapgl-cooperative-gestures');
        }
    ...
    _onCooperativeGesture(showNotification: boolean) {
        ...
        this._container.classList.add('vietmapgl-show');
        setTimeout(() => {
            this._container.classList.remove('vietmapgl-show');
        }, 100);
    }
}
