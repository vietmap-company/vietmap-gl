...
export class Map extends Camera {
    ...
    _setupContainer() {
        ...
        container.classList.add('vietmapgl-map');

        const canvasContainer = this._canvasContainer = DOM.create('div', 'vietmapgl-canvas-container', container);
        if (this._interactive) {
            canvasContainer.classList.add('vietmapgl-interactive');
        }

        this._canvas = DOM.create('canvas', 'vietmapgl-canvas', canvasContainer);
        ...
        const controlContainer = this._controlContainer = DOM.create('div', 'vietmapgl-control-container', container);
        const positions = this._controlPositions = {};
        ['top-left', 'top-right', 'bottom-left', 'bottom-right'].forEach((positionName) => {
            positions[positionName] = DOM.create('div', `vietmapgl-ctrl-${positionName} `, controlContainer);
        });
    ...
    remove() {
        ...
        this._container.classList.remove('vietmapgl-map');
