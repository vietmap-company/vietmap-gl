...
describe('FullscreenControl', () => {
    test('renders control', () => {
        ...
        expect(map.getContainer().querySelectorAll('.vietmapgl-ctrl-fullscreen')).toHaveLength(1);
    });
    ...
    test('uses pseudo fullscreen when fullscreen is not supported', () => {
        ...
        expect(mapContainer.classList.contains('vietmapgl-pseudo-fullscreen')).toBe(false);
        control._onClickFullscreen();
        expect(mapContainer.classList.contains('vietmapgl-pseudo-fullscreen')).toBe(true);
        control._onClickFullscreen();
        expect(mapContainer.classList.contains('vietmapgl-pseudo-fullscreen')).toBe(false);
    });
