...
export class NavigationControl implements IControl {
    ...
    constructor(options?: NavigationControlOptions) {
        ...
        if (this.options.showZoom) {
            this._zoomInButton = this._createButton('vietmapgl-ctrl-zoom-in', (e) => this._map.zoomIn({}, {originalEvent: e}));
            DOM.create('span', 'vietmapgl-ctrl-icon', this._zoomInButton).setAttribute('aria-hidden', 'true');
            this._zoomOutButton = this._createButton('vietmapgl-ctrl-zoom-out', (e) => this._map.zoomOut({}, {originalEvent: e}));
            DOM.create('span', 'vietmapgl-ctrl-icon', this._zoomOutButton).setAttribute('aria-hidden', 'true');
        }
        if (this.options.showCompass) {
            this._compass = this._createButton('vietmapgl-ctrl-compass', (e) => {
            ...
            this._compassIcon = DOM.create('span', 'vietmapgl-ctrl-icon', this._compass);
