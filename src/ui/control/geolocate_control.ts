...
export class GeolocateControl extends Evented implements IControl {
    ...
    onAdd(map: Map) {
        this._map = map;
        this._container = DOM.create('div', 'vietmapgl-ctrl vietmapgl-ctrl-group');
    ...
    _setErrorState() {
        switch (this._watchState) {
            case 'WAITING_ACTIVE':
                ...
                this._geolocateButton.classList.remove('vietmapgl-ctrl-geolocate-active');
                this._geolocateButton.classList.add('vietmapgl-ctrl-geolocate-active-error');
                break;
            case 'ACTIVE_LOCK':
                this._watchState = 'ACTIVE_ERROR';
                this._geolocateButton.classList.remove('vietmapgl-ctrl-geolocate-active');
                this._geolocateButton.classList.add('vietmapgl-ctrl-geolocate-active-error');
                this._geolocateButton.classList.add('vietmapgl-ctrl-geolocate-waiting');
                // turn marker grey
                break;
            case 'BACKGROUND':
                this._watchState = 'BACKGROUND_ERROR';
                this._geolocateButton.classList.remove('vietmapgl-ctrl-geolocate-background');
                this._geolocateButton.classList.add('vietmapgl-ctrl-geolocate-background-error');
                this._geolocateButton.classList.add('vietmapgl-ctrl-geolocate-waiting');
                // turn marker grey
                break;
            case 'ACTIVE_ERROR':
    ...
    _onSuccess = (position: GeolocationPosition) => {
        ...
        if (this.options.trackUserLocation) {
            ...
            switch (this._watchState) {
                ...
                case 'ACTIVE_ERROR':
                    ...
                    this._geolocateButton.classList.remove('vietmapgl-ctrl-geolocate-waiting');
                    this._geolocateButton.classList.remove('vietmapgl-ctrl-geolocate-active-error');
                    this._geolocateButton.classList.add('vietmapgl-ctrl-geolocate-active');
                    break;
                case 'BACKGROUND':
                case 'BACKGROUND_ERROR':
                    this._watchState = 'BACKGROUND';
                    this._geolocateButton.classList.remove('vietmapgl-ctrl-geolocate-waiting');
                    this._geolocateButton.classList.remove('vietmapgl-ctrl-geolocate-background-error');
                    this._geolocateButton.classList.add('vietmapgl-ctrl-geolocate-background');
                    break;
                default:
                    throw new Error(`Unexpected watchState ${this._watchState}`);
            }
        ...
        if (this.options.showUserLocation) {
            this._dotElement.classList.remove('vietmapgl-user-location-dot-stale');
        }
    ...
    _onError = (error: GeolocationPositionError) => {
        ...
        if (this._watchState !== 'OFF' && this.options.showUserLocation) {
            this._dotElement.classList.add('vietmapgl-user-location-dot-stale');
        }
    ...
    _setupUI = (supported: boolean) => {
        ...
        this._geolocateButton = DOM.create('button', 'vietmapgl-ctrl-geolocate', this._container);
        DOM.create('span', 'vietmapgl-ctrl-icon', this._geolocateButton).setAttribute('aria-hidden', 'true');
        ...
        if (this.options.showUserLocation) {
            this._dotElement = DOM.create('div', 'vietmapgl-user-location-dot');

            this._userLocationDotMarker = new Marker({element: this._dotElement});

            this._circleElement = DOM.create('div', 'vietmapgl-user-location-accuracy-circle');
