...
describe('NavigationControl', () => {
    test('appears in the top-right', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.vietmapgl-ctrl-top-right > .vietmapgl-ctrl')
        ).toHaveLength(1);
    });
    ...
    test('contains zoom in button', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.vietmapgl-ctrl-zoom-in')
        ).toHaveLength(1);
    });
    ...
    test('contains zoom out button', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.vietmapgl-ctrl-zoom-out')
        ).toHaveLength(1);
    });
    ...
    test('contains compass button', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.vietmapgl-ctrl-compass')
        ).toHaveLength(1);
    });
    ...
    test('compass button reset action', () => {
        ...
        const navButton = map.getContainer().querySelector('.vietmapgl-ctrl-compass');
