...
export class FullscreenControl extends Evented implements IControl {
    ...
    onAdd(map: Map): HTMLElement {
        ...
        this._controlContainer = DOM.create('div', 'vietmapgl-ctrl vietmapgl-ctrl-group');
        this._setupUI();
    ...
    _setupUI() {
        const button = this._fullscreenButton = DOM.create('button', (('vietmapgl-ctrl-fullscreen')), this._controlContainer);
        DOM.create('span', 'vietmapgl-ctrl-icon', button).setAttribute('aria-hidden', 'true');
        button.type = 'button';
        this._updateTitle();
