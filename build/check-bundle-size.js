...
const beforejs = fileSize('./before/vietmap-gl.js');
const beforecss = fileSize('./before/vietmap-gl.css');
const afterjs = fileSize('./after/vietmap-gl.js');
const aftercss = fileSize('./after/vietmap-gl.css');
...
| :--- | :---: | :---: | :---: |
| vietmap-gl.js | ${prettyBytes(beforejs.gzipped)} | ${prettyBytes(afterjs.gzipped)} | ${prettyBytes(afterjs.gzipped - beforejs.gzipped, { signed: true })} |
| vietmap-gl.css | ${prettyBytes(beforecss.gzipped)} | ${prettyBytes(aftercss.gzipped)} | ${prettyBytes(aftercss.gzipped - beforecss.gzipped, { signed: true })} |`);
